...
- 功能文件：一個功能的為什麼做、做什麼，讀者是 PM、設計師、架構師與工程師，見 [功能文件範本](features/_feature_template.md)
- 技術設計：一個功能怎麼做，讀者是工程師，見 [documentation.md](../conventions/documentation.md)
- 使用者故事：功能文件的一章，是一個可以單獨交付的價值切片，見 [功能文件範本](features/_feature_template.md)
- 〔規劃中〕：標在尚未實作的使用者故事或被改到的那一行，見 [功能文件範本](features/_feature_template.md)
