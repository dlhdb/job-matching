"""工作評分需要網路的測試：把固定的測試職缺匯入測試資料庫，以 Gemini API 評所有還沒評分的職缺，並印出 AI 給的理由供使用者閱讀。"""
...
@pytest.mark.network
def test_ai_scoring(e2e_db, capsys):
